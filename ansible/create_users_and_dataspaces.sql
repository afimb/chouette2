...
BEGIN
  PERFORM clone_schema('public',dest_schema);
  REASSIGN OWNED BY postgres TO chouette;
 insert into public.referentials(name,slug,created_at,updated_at,prefix,projection_type, time_zone, bounds,organisation_id , geographical_bounds , user_id ,user_name ,data_format ) values(dataspace_name,dest_schema, current_timestamp,current_timestamp,dataspace_prefix,dataspace_projection,dataspace_timezone,dataspace_bounds,organisation_id,null,user_id,admin_user_name,dataspace_format);
...
insert into public.organisations(name,created_at,updated_at,data_format) values ('Rutebanken',current_timestamp,current_timestamp,'neptune');
...
SELECT create_rutebanken_schema('rb_ost','RB/Østfold Kollektivtrafikk','neptune','Rutebanken Admin', get_variable('organisation_id'), get_variable('user_id'),'OST','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_rut','RB/Ruter','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'RUT','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_hed','RB/Hedmark-Trafikk','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'HED','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_opp','RB/Opplandstrafikk','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'OPP','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_bra','RB/Brakar','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'BRA','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_vkt','RB/Vestfold','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'VKT','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_akt','RB/Ruter','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'RUT','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_kol','RB/Kolumbus','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'KOL','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_hrd','RB/Skyss','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'HRD','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_sof','RB/Kringom','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'SOF','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_mor','RB/Fram','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'MOR','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_atb','RB/AtB','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'ATB','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_ntr','RB/Nord-Trøndelag','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'NTR','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_nor','RB/Nordland','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'NOR','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_tro','RB/Troms','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'TRO','32633','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_fin','RB/Snelandia','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'FIN','32633','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_tog','RB/NSB','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'TOG','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_tel','RB/Telemark Kollektivtrafik','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'TEL','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_nri','RB/NRI','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'NRI','4326','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
...
SELECT create_rutebanken_schema('rb_norway','RB/NOR-WAY','neptune','Rutebanken Admin',get_variable('organisation_id'), get_variable('user_id'),'NORWAY','32632','Paris','SRID=4326;POLYGON((3.0 57.0,3.0 62.0,10.0 62.0,10.0 57.0,3.0 57.0))');
