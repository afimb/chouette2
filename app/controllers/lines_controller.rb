class LinesController < ChouetteController
  ...
  def line_params
    params.require(:line).permit( :network_id, :company_id, :objectid, :object_version, :creation_time, :creator_id,
                                  :name, :number, :published_name, :transport_mode_name, :transport_submode_name, :registration_number, :comment,
