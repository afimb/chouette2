...
Afin d'organiser les calendriers dont le nombre peut être assez important, une fonction permet d'y adjoindre une ou plusieurs étiquettes. Pour créer une nouvelle étiquettes, il suffit de taper son nom dans le champ "_étiquettes_" puis d'appuyer sur entrée. Il est possible de les supprimer en cliquant sur la petite croix de l'étiquette déjà existante. 
