...
CHOUETTE est un logiciel libre développé à l'initiative du ministère français de la Transition écologique et solidaire, dans le but de faciliter l'échange de données d'offre (théorique) de transport collectif (TC), en s'appuyant pour cela sur la norme NFP 99506, dite Neptune, qui spécifie un profil d'échange XML.
...
Le manuel couvre la version 3.4.2.
