...
** connection possible en utilisant les comptes Google, facebook ou France-connect 

h4. Version 3.4.0

* Nouvelles fonctionnalités :
** rapport de validation des fichiers produits à l'export (Neptune et GTFS)

h4. Version 3.3.0

* Nouvelles fonctionnalités :
** Export des tracés au formats KML et GeoJson (export SIG)
