class RuleParameterSet < ActiveRecord::Base
  ...
  def self.mode_default_params
    ...
    :water => {
      :allowed_transport_mode_water => false,
      :inter_stop_area_distance_min_mode_water => 200,
      :inter_stop_area_distance_max_mode_water => 10000,
      :speed_max_mode_water => 40,
      :speed_min_mode_water => 5,
      :inter_stop_duration_variation_max_mode_water => 60},
    :bus => {
    ...
    :rail => {
      :allowed_transport_mode_rail => false,
      :inter_stop_area_distance_min_mode_rail => 2000,
      :inter_stop_area_distance_max_mode_rail => 500000,
      :speed_max_mode_rail => 300,
      :speed_min_mode_rail => 20,
      :inter_stop_duration_variation_max_mode_rail => 60},
    :tram => {
      :allowed_transport_mode_tram => false,
      :inter_stop_area_distance_min_mode_tram => 300,
      :inter_stop_area_distance_max_mode_tram => 2000,
      :speed_max_mode_tram => 50,
      :speed_min_mode_tram => 20,
      :inter_stop_duration_variation_max_mode_tram => 30},
    :trolley_bus => {
      :allowed_transport_mode_trolley_bus => false,
      :inter_stop_area_distance_min_mode_trolley_bus => 300,
      :inter_stop_area_distance_max_mode_trolley_bus => 2000,
      :speed_max_mode_trolley_bus => 50,
      :speed_min_mode_trolley_bus => 20,
      :inter_stop_duration_variation_max_mode_trolley_bus => 30},
    :cableway => {
      :allowed_transport_mode_cableway => false,
      :inter_stop_area_distance_min_mode_cableway => 300,
      :inter_stop_area_distance_max_mode_cableway => 2000,
      :speed_max_mode_cableway => 50,
      :speed_min_mode_cableway => 20,
      :inter_stop_duration_variation_max_mode_cableway => 30},
    :funicular => {
      :allowed_transport_mode_funicular => false,
      :inter_stop_area_distance_min_mode_funicular => 300,
      :inter_stop_area_distance_max_mode_funicular => 2000,
      :speed_max_mode_funicular => 50,
      :speed_min_mode_funicular => 20,
      :inter_stop_duration_variation_max_mode_funicular => 30},
    :lift => {
      :allowed_transport_mode_lift => false,
      :inter_stop_area_distance_min_mode_lift => 300,
      :inter_stop_area_distance_max_mode_lift => 2000,
      :speed_max_mode_lift => 50,
      :speed_min_mode_lift => 20,
      :inter_stop_duration_variation_max_mode_lift => 30},
    :private_vehicle => {
    ...
    # :water, :bus, :ferry, :walk, :metro, :rapidtransit, :taxi, :localtrain, :train, :longdistancetrain, :tram, :trolley_bus, :privatevehicle, :bicycle, :other
  end
