class AddForeignKeysToFootnotes < ActiveRecord::Migration
  def change
    execute <<-SQL
      alter table footnotes_vehicle_journey_at_stops ADD constraint footnotes_vehicle_journey_at_stops_vjas_fkey FOREIGN KEY (vehicle_journey_at_stop_id) REFERENCES vehicle_journey_at_stops not valid;
      alter table footnotes_vehicle_journey_at_stops ADD constraint footnotes_vehicle_journey_at_stops_footnotes_fkey FOREIGN KEY (footnote_id) REFERENCES footnotes not valid;
    ...
    execute <<-SQL
      alter table footnotes_lines ADD constraint footnotes_lines_lines_fkey FOREIGN KEY (line_id) REFERENCES lines not valid;
      alter table footnotes_lines ADD constraint footnotes_lines_footnotes_fkey FOREIGN KEY (footnote_id) REFERENCES footnotes not valid;
    ...
    execute <<-SQL
      alter table footnotes_journey_patterns ADD constraint footnotes_journey_patterns_journey_patterns_fkey FOREIGN KEY (journey_pattern_id) REFERENCES journey_patterns not valid;
      alter table footnotes_journey_patterns ADD constraint footnotes_journey_patterns_footnotes_fkey FOREIGN KEY (footnote_id) REFERENCES footnotes not valid;
    ...
    execute <<-SQL
      alter table footnotes_vehicle_journeys ADD constraint footnotes_vehicle_journeys_vehicle_journeys_fkey FOREIGN KEY (vehicle_journey_id) REFERENCES vehicle_journeys not valid;
      alter table footnotes_vehicle_journeys ADD constraint footnotes_vehicle_journeys_footnotes_fkey FOREIGN KEY (footnote_id) REFERENCES footnotes not valid;
    ...
    execute <<-SQL
      alter table footnotes_stop_points ADD constraint footnotes_stop_points_stop_points_fkey FOREIGN KEY (stop_point_id) REFERENCES stop_points not valid;
      alter table footnotes_stop_points ADD constraint footnotes_stop_points_footnotes_fkey FOREIGN KEY (footnote_id) REFERENCES footnotes not valid;
