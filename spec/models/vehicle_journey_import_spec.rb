...
describe VehicleJourneyImport, :type => :model do
  ...
  let!(:vehicle_journey1) { create(:vehicle_journey_common, :objectid => "vehiclejourney_1", :route_id => route.id, :journey_pattern_id => journey_pattern.id) }
  let!(:vehicle_journey2) { create(:vehicle_journey_common, :objectid => "vehiclejourney_2", :route_id => route.id, :journey_pattern_id => other_journey_pattern.id) }
  let!(:vehicle_journey3) { create(:vehicle_journey_common, :objectid => "vehiclejourney_3", :route_id => route.id, :journey_pattern_id => journey_pattern.id) }
